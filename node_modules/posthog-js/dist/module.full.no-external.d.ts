...
import { PerformanceCaptureConfig, SessionRecordingCanvasOptions, InitiatorType, CapturedNetworkRequest, SessionRecordingOptions, JsonType, FeatureFlagDetail, EventName, Properties, RageclickConfig, SessionIdChangedCallback, DeadClicksAutoCaptureConfig, SeverityLevel, SupportedWebVitalsMetrics, CaptureResult, PostHogConfig, FeatureFlagsCallback, RemoteConfigFeatureFlagCallback, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, RequestResponse, RequestQueueConfig, PostHog as PostHog$1, RequestCallback, CaptureOptions, Property, ExceptionAutoCaptureConfig } from '@posthog/types';
export { AutocaptureCompatibleElement, AutocaptureConfig, BeforeSendFn, BootstrapConfig, CaptureOptions, CaptureResult, CapturedNetworkRequest, ConfigDefaults, DeadClickCandidate, DeadClicksAutoCaptureConfig, DomAutocaptureEvents, EarlyAccessFeature, EarlyAccessFeatureCallback, EarlyAccessFeatureResponse, EarlyAccessFeatureStage, ErrorTrackingOptions, EvaluationReason, EventName, ExceptionAutoCaptureConfig, ExternalIntegrationKind, FeatureFlagDetail, FeatureFlagMetadata, FeatureFlagsCallback, Headers, HeatmapConfig, InitiatorType, JsonRecord, JsonType, KnownEventName, MaskInputOptions, NetworkRequest, PerformanceCaptureConfig, PostHogConfig, PostHog as PostHogInterface, Properties, Property, RageclickConfig, RemoteConfigFeatureFlagCallback, RequestCallback, RequestQueueConfig, RequestResponse, SessionIdChangedCallback, SessionRecordingCanvasOptions, SessionRecordingOptions, SeverityLevel, SlimDOMOptions, SupportedWebVitalsMetrics } from '@posthog/types';
 ...
 * @constructor
 */
declare class PostHog implements PostHog$1 {
    __loaded: boolean;
...
export type { ActionStepStringMatching, ActionStepType, BasicSurveyQuestion, Breaker, ConversationsRemoteConfig, ConversationsTraits, ConversationsWidgetState, DisplaySurveyOptions, ErrorEventArgs, ErrorTrackingSuppressionRule, ErrorTrackingSuppressionRuleValue, EventHandler, FlagVariant, FlagsResponse, GetMessagesResponse, GetTicketsOptions, GetTicketsResponse, JSONContent, LinkSurveyQuestion, MarkAsReadResponse, Message, MessageAuthorType, MultipleSurveyQuestion, NetworkRecordOptions, OverrideConfig, PersistentStore, ProductTour, ProductTourAppearance, ProductTourCallback, ProductTourConditions, ProductTourDismissReason, ProductTourRenderReason, ProductTourSelectorError, ProductTourStep, ProductTourStepType, ProductTourSurveyQuestion, ProductTourSurveyQuestionType, PropertyFilters, PropertyMatchType, PropertyOperator, QueuedRequestWithOptions, RatingSurveyQuestion, RemoteConfig, RequestWithOptions, RetriableRequestWithOptions, SendMessageResponse, SessionRecordingPersistedConfig, SessionRecordingRemoteConfig, SessionRecordingUrlTrigger, SessionStartReason, ShowTourOptions, SiteApp, SiteAppGlobals, SiteAppLoader, SnippetArrayItem, Survey, SurveyActionType, SurveyAppearance, SurveyCallback, SurveyConfig, SurveyElement, SurveyEventWithFilters, SurveyQuestion, SurveyQuestionDescriptionContentType, SurveyRenderReason, SurveyWithTypeAndAppearance, Ticket, TicketStatus, ToolbarParams, ToolbarSource, ToolbarUserIntent, ToolbarVersion, UserProvidedTraits };
